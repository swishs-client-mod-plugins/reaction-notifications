...
Sends a desktop notification when someone reacts to your message.
...
```
git clone https://github.com/swishs-client-mod-plugins/reaction-notifications
```

Or run this command in the Vizality Client:

```
.plugin install https://github.com/swishs-client-mod-plugins/reaction-notifications
```
